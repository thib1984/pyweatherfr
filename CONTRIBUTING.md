...
To contribute, it's simple, check the [existing issues](https://github.com/thib1984/pyweatherfr/issues). If you see an issue you are interested to work, please let a message and i assign you the task. With this, all people know you are working on this issue.
...
git clone https://github.com/thib1984/pyweatherfr.git
...
rm -rf pyweatherfr_env 

# Create a virtual environment to isolate dependencies for this project
python3 -m venv pyweatherfr_env
source pyweatherfr_env/bin/activate
