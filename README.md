...
## Autres options
  ...
  - ``-m/--minimize`` affiche uniquement les données indispensables
  - ``-c/--condensate` réduit la hauteur des données en sortie
  - ``--serious`` retire les easter eggs (mais trouvez les d'abord!)
